...
void ui_BEGIN_screen_init(void)
{
    ...
    lv_obj_set_pos(ui_toppic, 100, 0);
    ...
    lv_obj_set_pos(ui_dowmpic, 100, 145);
...
void ui_MENU_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_MENU, &ui_img_crowpanel_ui_bj_dis04028h_png, LV_PART_MAIN | LV_STATE_DEFAULT);
